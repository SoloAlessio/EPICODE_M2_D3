...
}else{ console.log("NUM2: ",num2 ," è più grande di NUM1: ", num1); }
...
console.log("Totale Carrelo: ", totalShoppingCart);
if(totalShoppingCart > 50){
  console.log("Promo Riscattata, Prezzo finale: ", totalShoppingCart);
}else{
  console.log("Promo Negata, Prezzo finale: ", totalShoppingCart + 10);
}
...
console.log("BLACK FRIDAY!, prezzo compreso di sconto: ", totalShoppingCart);
